...
void DrawMenu()
{
	...
	// DrawInspector();
	static int page = 0;
	if (ImGui::Begin("[  DEATH NOTE | By Togami  ]", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings))
	{
		...
		case 0:
			...
			ImGui::Checkbox("Player Box", &vars::PlayerBoxESP);
			ImGui::SameLine();
